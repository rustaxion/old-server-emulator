...
public class Login
{
    ...
    public Login()
    {
                ...
                Index.Instance.LoginPackageQueue.Enqueue(
                    new Index.GamePackage()
                    {
                        ...
                        Data = Index.ObjectToByteArray(
                            new cometLogin.Ret_GameVersion()
                            {
                                version = gameVersion,
                                announcementContent = "",
                                announcementTitle = "",
        ...
        Handlers.Add(
            (uint)cometLogin.ParaCmd.ParaCmd_Req_ThirdLogin,
            (byte[] msgContent) =>
            {
    ...
    {
        if (!Handlers.ContainsKey(paraCmd))
            return false;
